...
def create_point_geom(x_coord,y_coord):
  ...
  -----------
  ・Parameters
  x coord and y coord : float
        Coordinates to be acquired
  -----------
  ・Returns
        point
  """
...
poly1 = create_poly_geom([(0,0),(0,12),(12,12),(12,0)])
# CODE FOR TESTING YOUR SOLUTION
